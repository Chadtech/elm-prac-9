...
Elm.World.make = function (_elm) {
   ...
   if (_elm.World.values) return _elm.World.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
...
Elm.Frame.make = function (_elm) {
   "use strict";
   _elm.Frame = _elm.Frame || {};
   if (_elm.Frame.values) return _elm.Frame.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Color = Elm.Color.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   var blinders = function (_p0) {
      ...
      var _p3 = _p1._0;
      var _p2 = _p1._1;
      var h$ = $Basics.toFloat(_p2) / 2;
      var w$ = $Basics.toFloat(_p3);
      var hBarWidth = $Basics.toFloat(_p3 - 501) / 2 + 1;
      var vBarHeight = $Basics.toFloat(_p2 - 501) / 2 + 1;
      var hBarHeight = $Basics.toFloat(_p2) - vBarHeight * 2 + 2;
      return $Graphics$Collage.toForm(A3($Graphics$Collage.collage,
      _p3,
      _p2,
      _U.list([A3(bar,w$,vBarHeight,{ctor: "_Tuple2",_0: 0,_1: h$ - vBarHeight / 2})
              ,A3(bar,w$,vBarHeight,{ctor: "_Tuple2",_0: 0,_1: 0 - h$ + vBarHeight / 2})
              ,A3(bar,hBarWidth,hBarHeight,{ctor: "_Tuple2",_0: (0 - (w$ - 500)) / 2 - 15,_1: 0})
              ,A3(bar,hBarWidth,hBarHeight,{ctor: "_Tuple2",_0: (w$ - 500) / 2 + 15,_1: 0})])));
   };
   var frame = F3(function (_p4,s,world) {
      var _p5 = _p4;
      var _p7 = _p5._0;
      var _p6 = _p5._1;
...
Elm.KeyCodes.make = function (_elm) {
   "use strict";
   _elm.KeyCodes = _elm.KeyCodes || {};
   if (_elm.KeyCodes.values) return _elm.KeyCodes.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
...
Elm.Physics.make = function (_elm) {
   ...
   $Types = Elm.Types.make(_elm);
   var _op = {};
   var rollAngleCC = function (a) {    rollAngleCC: while (true) if (_U.cmp(a,-180) < 0) {    var _v0 = a + 360;a = _v0;continue rollAngleCC;} else return a;};
   var rollAngleC = function (a) {    rollAngleC: while (true) if (_U.cmp(a,180) > 0) {    var _v1 = a - 3600;a = _v1;continue rollAngleC;} else return a;};
   var rollXLeft = function (x) {    rollXLeft: while (true) if (_U.cmp(x,-250) < 0) {    var _v2 = x + 500;x = _v2;continue rollXLeft;} else return x;};
   var rollXRight = function (x) {    rollXRight: while (true) if (_U.cmp(x,250) > 0) {    var _v3 = x - 500;x = _v3;continue rollXRight;} else return x;};
   var rollYBottom = function (y) {    rollYBottom: while (true) if (_U.cmp(y,-250) < 0) {    var _v4 = y + 500;y = _v4;continue rollYBottom;} else return y;};
   var rollYTop = function (y) {    rollYTop: while (true) if (_U.cmp(y,250) > 0) {    var _v5 = y - 500;y = _v5;continue rollYTop;} else return y;};
   ...
   return _elm.Physics.values = {_op: _op
                                ,rollYTop: rollYTop
                                ,rollYBottom: rollYBottom
                                ,rollXRight: rollXRight
                                ,rollXLeft: rollXLeft
                                ,rollAngleC: rollAngleC
